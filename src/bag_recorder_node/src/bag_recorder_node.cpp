...
public:
    BagRecorderNode(const rclcpp::NodeOptions& options):
        ...
        image_topic.name = "/image_for_radar/compressed";
        image_topic.type = "sensor_msgs/msg/CompressedImage";
        ...
        options_sub.use_intra_process_comm =
        ...
        rclcpp::on_shutdown([this]() { this->stopRecording(); });
...
private:
    ...
    void imageCallback(const sensor_msgs::msg::Image::SharedPtr msg) {
        ...
        serializer.serialize_message(&compressed_msg, &serialized);

        writer_->write(
            serialized,
            "/image_for_radar/compressed",
